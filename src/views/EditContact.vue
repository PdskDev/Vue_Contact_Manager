<template>
    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          provident nihil odit alias laudantium voluptatum nulla deleniti error
          sequi, voluptatem vitae voluptate deserunt ducimus amet atque sit eum
          voluptas!
        </p>
      </div>
    </div>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-4">
        <form @submit.prevent="submitUpdateContact()">
          <div class="mb-2">
            <input
              required
...
export default {
  ...
  created: async function () {
    try {
      this.loading = true;
      let response = await ContactService.getOneContact(this.contactId);
  ...
  methods: {
    ...
    submitUpdateContact: async function () {
      try {
